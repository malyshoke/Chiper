...
// Обратная начальная замена таблицы IP1
...
// Количество цифр, перемещаемых за раунд
...
string iterative_en(string L, string R, string* K, MODE mode);
...
string ECB_en(string data, string key, MODE mode);
string ECB_de(string data, string key, MODE mode);
